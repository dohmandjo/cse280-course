...
express the following propositions in English sentences (the first two are done for you):
...
|$\exists x \ S(x)$|There exist a person who is a student.|
|$\forall x \ S(x)$|All people are students.|
|$\neg \exists x \ S(x)$|It doesn't exist a person who is a student.|
|$\exists x \ \neg S(x)$|There exist a person who is not a student.|
|$\neg \forall x \ \neg S(x)$|Not everyone is not a student.|
|$\forall x \ \neg S(x)$|Everyone is not a student.|
...
|$\exists x \forall y \ P(x,y)$|$\forall x \exist y \ \neg P(x,y)$|
|$\exists x \exists y \forall z \ \neg P(x,y,z)$|$\forall x \forall y \exist z P(x,y,z)$|
|$\forall x \exists y \forall z \ P(x,y,z)$|$\exist x \forall y \exist z \neg P(x,y,z)$|
